...
SET ERRORLEVEL=
cmake -G "Visual Studio 14 Win64" ..\.. -DCMAKE_CONFIGURATION_TYPES="Release"  -DPL_DOUBLE=ON -DLIB_TAG="su" -DBUILD_TEST=ON -DBUILD_SHARED_LIBS=OFF -DSTATIC_RUNTIME=ON -DwxWidgets_CONFIGURATION=mswud -DHAVE_SHAPELIB=ON -DSHAPELIB_INCLUDE_DIR="%BASEDIR%/shapelib-1.3.0" -DSHAPELIB_LIBRARY="%BASEDIR%/shapelib-1.3.0/shapelib_i.lib" -DHAVE_AGG=ON -DAGG_INCLUDE_DIR="%BASEDIR%/agg-svn-117/agg-2.4/include" -DAGG_LIBRARIES="%BASEDIR%/agg-svn-117/agg-2.4/build_vs2015/lib/Release/agg.lib" -DWITH_FREETYPE=ON -DFREETYPE_INCLUDE_DIR="%BASEDIR%/freetype-2.6.3/include" -DFREETYPE_LIBRARY="%BASEDIR%/freetype-2.6.3/build_vs205/Release/freetype.lib"
...
cd %BUILDDIR%/debug
SET ERRORLEVEL=
::cmake -G "Visual Studio 14 Win64" ..\.. -DCMAKE_CONFIGURATION_TYPES="Debug"  -DPL_DOUBLE=ON -DLIB_TAG="su" -DBUILD_TEST=ON -DBUILD_SHARED_LIBS=OFF -DSTATIC_RUNTIME=ON -DwxWidgets_CONFIGURATION=mswud -DHAVE_SHAPELIB=ON -DSHAPELIB_INCLUDE_DIR="%BASEDIR%/shapelib-1.3.0" -DSHAPELIB_LIBRARY="%BASEDIR%/shapelib-1.3.0/shapelib.lib" -DHAVE_AGG=ON -DAGG_INCLUDE_DIR="%BASEDIR%/agg-svn-117/agg-2.4/include" -DAGG_LIBRARIES="%BASEDIR%/agg-svn-117/agg-2.4/build_vs2015/lib/Debug/agg.lib" -DWITH_FREETYPE=ON -DFREETYPE_INCLUDE_DIR="%BASEDIR%/freetype-2.6.3/include" -DFREETYPE_LIBRARY="%BASEDIR%/freetype-2.6.3/build_vs205/Debug/freetyped.lib"
