...
{
public:
	Information_Page_Implementation(wxFrame* parent);
...
Information_Page_Implementation<MasterType,ParentType,InheritanceList>::Information_Page_Implementation(wxFrame* parent) : wxPanel(parent,-1,wxDefaultPosition,wxDefaultSize,wxCLIP_CHILDREN )
{
