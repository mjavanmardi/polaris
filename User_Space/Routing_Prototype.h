	...
	namespace Prototypes
	{
		...
		prototype struct Routable_Network_Prototype
		{
			...
			feature_prototype void Reset()
			{
				...
				define_container_and_value_interface(_Reversed_Path_Container_Interface, _Regular_Link_Interface, get_type_of(reversed_path_container), Random_Access_Sequence_Prototype, Link_Prototype, ComponentType);  
				reversed_path_container<_Reversed_Path_Container_Interface&>().clear();

				define_container_and_value_interface(_Routable_Links_Container_Interface, _Routable_Link_Interface, get_type_of(links), Random_Access_Sequence_Prototype, Link_Prototype, ComponentType);
			...
			{
				define_container_and_value_interface(_Routable_Links_Container_Interface, _Routable_Link_Interface, get_type_of(links), Random_Access_Sequence_Prototype, Link_Prototype, ComponentType);
				define_container_and_value_interface(_Routable_Intersections_Container_Interface, _Routable_Intersection_Interface, get_type_of(intersections), Random_Access_Sequence_Prototype, Intersection_Prototype, ComponentType);
				...
				define_container_and_value_interface(_Routable_Inbound_Outbound_Movements_Container_Interface, _Routable_Inbound_Outbound_Movements_Interface, _Routable_Intersection_Interface::get_type_of(inbound_outbound_movements), Random_Access_Sequence_Prototype, Inbound_Outbound_Movements_Prototype, ComponentType);
				define_container_and_value_interface(_Routable_Movements_Container_Interface, _Routable_Movement_Interface, _Routable_Outbound_Inbound_Movements_Interface::get_type_of(inbound_movements), Random_Access_Sequence_Prototype, Movement_Prototype, ComponentType);

				typedef Network_Prototype<ComponentType::regular_network_type, ComponentType> _Regular_Network_Interface;
				define_container_and_value_interface(_Regular_Links_Container_Interface, _Regular_Link_Interface, ComponentType::regular_network_type::links_container_type, Random_Access_Sequence_Prototype, Link_Prototype, ComponentType);
				define_container_and_value_interface(_Regular_Intersections_Container_Interface, _Regular_Intersection_Interface, ComponentType::regular_network_type::intersections_container_type, Random_Access_Sequence_Prototype, Intersection_Prototype, ComponentType);
				define_container_and_value_interface(_Regular_Outbound_Inbound_Movements_Container_Interface, _Regular_Outbound_Inbound_Movements_Interface, _Regular_Intersection_Interface::get_type_of(outbound_inbound_movements), Random_Access_Sequence_Prototype, Outbound_Inbound_Movements_Prototype, ComponentType);
				define_container_and_value_interface(_Regular_Inbound_Outbound_Movements_Container_Interface, _Regular_Inbound_Outbound_Movements_Interface, _Regular_Intersection_Interface::get_type_of(inbound_outbound_movements), Random_Access_Sequence_Prototype, Inbound_Outbound_Movements_Prototype, ComponentType);
				define_container_and_value_interface(_Regular_Movements_Container_Interface, _Regular_Movement_Interface, _Regular_Outbound_Inbound_Movements_Interface::get_type_of(inbound_movements), Random_Access_Sequence_Prototype, Movement_Prototype, ComponentType);
				...
				for(regular_link_itr=regular_links_container.begin(); regular_link_itr!=regular_links_container.end(); regular_link_itr++)
				{
					...
					_Routable_Link_Interface* routable_link =  (_Routable_Link_Interface*)Allocate<_Routable_Link_Interface::Component_Type>();
				...
				for(regular_intersection_itr=regular_intersections_container.begin(); regular_intersection_itr!=regular_intersections_container.end(); regular_intersection_itr++)
				{
					...
					_Routable_Intersection_Interface* routable_intersection =  (_Routable_Intersection_Interface*)Allocate<_Routable_Intersection_Interface::Component_Type>();
					...
					for(regular_inbound_outbound_movements_itr=regular_inbound_outbound_movements_container.begin(); regular_inbound_outbound_movements_itr!=regular_inbound_outbound_movements_container.end(); regular_inbound_outbound_movements_itr++)
					{
						...
						_Routable_Inbound_Outbound_Movements_Interface* routable_inbound_outbound_movements = (_Routable_Inbound_Outbound_Movements_Interface*)Allocate<_Routable_Inbound_Outbound_Movements_Interface::Component_Type>();
						//float forward_link_turn_travel_time = regular_outbound_inbound_movements->forward_link_turn_travel_time<float>();
						//routable_outbound_inbound_movements->forward_link_turn_travel_time<float>(forward_link_turn_travel_time);
						...
						for(regular_outbound_movement_itr=regular_outbound_movements_container.begin(); regular_outbound_movement_itr!=regular_outbound_movements_container.end(); regular_outbound_movement_itr++)
						{
							...
							_Routable_Movement_Interface* routable_outbound_movement = (_Routable_Movement_Interface*)Allocate<_Routable_Movement_Interface::Component_Type>();
					...
					for(regular_outbound_inbound_movements_itr=regular_outbound_inbound_movements_container.begin(); regular_outbound_inbound_movements_itr!=regular_outbound_inbound_movements_container.end(); regular_outbound_inbound_movements_itr++)
					{
						...
						_Routable_Outbound_Inbound_Movements_Interface* routable_outbound_inbound_movements = (_Routable_Outbound_Inbound_Movements_Interface*)Allocate<_Routable_Outbound_Inbound_Movements_Interface::Component_Type>();
						//float forward_link_turn_travel_time = regular_outbound_inbound_movements->forward_link_turn_travel_time<float>();
						//routable_outbound_inbound_movements->forward_link_turn_travel_time<float>(forward_link_turn_travel_time);
						...
						for(regular_inbound_movement_itr=regular_inbound_movements_container.begin(); regular_inbound_movement_itr!=regular_inbound_movements_container.end(); regular_inbound_movement_itr++)
						{
							...
							_Routable_Movement_Interface* routable_inbound_movement = (_Routable_Movement_Interface*)Allocate<_Routable_Movement_Interface::Component_Type>();
		...
		prototype struct Routing_Prototype
		{
			...
			declare_feature_conditional(Compute_Route_Condition)
			{
				...
				define_component_interface(_Traveler_Interface, get_type_of(traveler), Traveler_Prototype, ComponentType);
			...
			feature_prototype void one_to_one_link_based_least_time_path_a_star()
			{

				define_component_interface(_Routable_Network_Interface, get_type_of(routable_network), Routable_Network_Prototype, ComponentType);
				define_component_interface(_Regular_Network_Interface, get_type_of(network), Network_Prototype, ComponentType);
				define_container_and_value_interface(_Routable_Links_Container_Interface, _Routable_Link_Interface, _Routable_Network_Interface::get_type_of(links), Random_Access_Sequence_Prototype, Link_Prototype, ComponentType);

				//typedef Link_Interface<ComponentType::routable_link_type, ComponentType> _Routable_Link_Interface;
				define_component_interface(_Routable_Intersection_Interface, ComponentType::routable_link_type::upstream_intersection_type, Intersection_Prototype, ComponentType);
				define_container_and_value_interface(_Inbound_Outbound_Movements_Container_Interface, _Inbound_Outbound_Movements_Interface, _Routable_Intersection_Interface::get_type_of(inbound_outbound_movements), Random_Access_Sequence_Prototype, Inbound_Outbound_Movements_Prototype, ComponentType);
				define_container_and_value_interface(_Movements_Container_Interface, _Movement_Interface, _Inbound_Outbound_Movements_Interface::get_type_of(outbound_movements), Random_Access_Sequence_Prototype, Movement_Prototype, ComponentType);
				define_container_and_value_interface(_Reversed_Path_Container_Interface, _Regular_Link_Interface, _Routable_Network_Interface::get_type_of(reversed_path_container), Random_Access_Sequence_Prototype, Link_Prototype, ComponentType);
			...
			declare_feature_event(Compute_Route)
			{
				...
				define_container_and_value_interface(_Reversed_Path_Container_Interface, _Regular_Link_Interface, ComponentType::routable_network_type::reversed_path_container_type, Random_Access_Sequence_Prototype, Link_Prototype, ComponentType);
