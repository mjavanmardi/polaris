...
namespace Person_Components
{
	...
	namespace Concepts
	{
		...
		{
			// component versions
			check_typed_member(has_gender,Gender, Types::GENDER);
	...
	namespace Prototypes
	{
		prototype struct Person_Properties ADD_DEBUG_INFO
		{
			...
			feature_accessor(Gender,none,none);
			feature_accessor(Race,none,none);
			feature_accessor(Age,none,none);
			feature_accessor(Class_of_worker,none,none);
			feature_accessor(Journey_To_Work_Travel_Time,none,none);
			feature_accessor(Journey_To_Work_Vehicle_Occupancy,none,none);
			feature_accessor(Journey_To_Work_Mode,none,none);
			feature_accessor(Marital_Status,none,none);
			feature_accessor(School_Enrollment,none,none);
			feature_accessor(School_Grade_Level,none,none);
			feature_accessor(Educational_Attainment,none,none);
			feature_accessor(Work_Hours,none,none);
			...
			feature_method_1_arg(Average_Activity_Duration, act_type, check_2(typename TargetType::ParamType, ACTIVITY_TYPES, is_same));
			feature_method_2_arg(Average_Activity_Frequency, act_type, value, check_2(typename TargetType::ParamType, ACTIVITY_TYPES, is_same) && check(typename TargetType::Param2Type, is_arithmetic));
			feature_method_2_arg(Average_Activity_Duration, act_type, value, check_2(typename TargetType::ParamType, ACTIVITY_TYPES, is_same) && check(typename TargetType::Param2Type, Is_Time_Value));
