...
//				using namespace Signal_Components::Data_Structures;
				...
				define_container_and_value_interface(_Intersections_Container_Interface, _Intersection_Interface, get_type_of(intersections_container), Random_Access_Sequence_Prototype, Intersection_Prototype, ComponentType);
				...
				_Intersection_Interface* intersection_0=(_Intersection_Interface*)Allocate<_Intersection_Interface::Component_Type>();
				...
				_Intersection_Interface* intersection_1=(_Intersection_Interface*)Allocate<_Intersection_Interface::Component_Type>();
				...
				_Intersection_Interface* intersection_2=(_Intersection_Interface*)Allocate<_Intersection_Interface::Component_Type>();
				...
				_Intersection_Interface* intersection_3=(_Intersection_Interface*)Allocate<_Intersection_Interface::Component_Type>();
				...
				_Intersection_Interface* intersection_4=(_Intersection_Interface*)Allocate<_Intersection_Interface::Component_Type>();
				...
				_Intersection_Interface* intersection_5=(_Intersection_Interface*)Allocate<_Intersection_Interface::Component_Type>();
				...
				_Intersection_Interface* intersection_6=(_Intersection_Interface*)Allocate<_Intersection_Interface::Component_Type>();
				...
				define_container_and_value_interface(_Links_Container_Interface, _Link_Interface, get_type_of(links_container), Random_Access_Sequence_Prototype, Link_Prototype, ComponentType);

				links_container<_Links_Container_Interface&>().clear();
				
				_Link_Interface* link_0 = (_Link_Interface*)Allocate<_Link_Interface::Component_Type>();
				_Link_Interface* link_1 = (_Link_Interface*)Allocate<_Link_Interface::Component_Type>();
				_Link_Interface* link_2 = (_Link_Interface*)Allocate<_Link_Interface::Component_Type>();
				_Link_Interface* link_3 = (_Link_Interface*)Allocate<_Link_Interface::Component_Type>();
				_Link_Interface* link_4 = (_Link_Interface*)Allocate<_Link_Interface::Component_Type>();
				_Link_Interface* link_5 = (_Link_Interface*)Allocate<_Link_Interface::Component_Type>();
				...
				define_container_and_value_interface(_Turn_Movements_Container_Interface, _Turn_Movement_Interface, get_type_of(turn_movements_container), Random_Access_Sequence_Prototype, Movement_Prototype, ComponentType);
				...
				_Turn_Movement_Interface* turn_movement_0 = (_Turn_Movement_Interface*)Allocate<_Turn_Movement_Interface::Component_Type>();
				...
				_Turn_Movement_Interface* turn_movement_1 = (_Turn_Movement_Interface*)Allocate<_Turn_Movement_Interface::Component_Type>();
				...
				_Turn_Movement_Interface* turn_movement_2 = (_Turn_Movement_Interface*)Allocate<_Turn_Movement_Interface::Component_Type>();
				...
				_Turn_Movement_Interface* turn_movement_3 = (_Turn_Movement_Interface*)Allocate<_Turn_Movement_Interface::Component_Type>();
				...
				_Turn_Movement_Interface* turn_movement_4 = (_Turn_Movement_Interface*)Allocate<_Turn_Movement_Interface::Component_Type>();
				...
				define_container_and_value_interface(_Outbound_Inbound_Movements_Container_Interface, _Outbound_Inbound_Movements_Interface, _Intersection_Interface::get_type_of(outbound_inbound_movements), Random_Access_Sequence_Prototype, Outbound_Inbound_Movements_Prototype, ComponentType);			
				...
				for (intersections_itr = intersections_container<_Intersections_Container_Interface&>().begin(); intersections_itr != intersections_container<_Intersections_Container_Interface&>().end(); intersections_itr++)
				{
					...
					for (links_itr = outbound_links.begin(); links_itr != outbound_links.end(); links_itr++)
					{
						...
						_Outbound_Inbound_Movements_Interface* outboundInboundMovements = (_Outbound_Inbound_Movements_Interface*)Allocate<_Outbound_Inbound_Movements_Interface::Component_Type>();
				...
				define_container_and_value_interface(_Inbound_Outbound_Movements_Container_Interface, _Inbound_Outbound_Movements_Interface, _Intersection_Interface::get_type_of(inbound_outbound_movements), Random_Access_Sequence_Prototype, Inbound_Outbound_Movements_Prototype, ComponentType);
				...
				for (i = 0; i < (int)intersections_container<_Intersections_Container_Interface&>().size(); i++)
				{
					...
					{
						_Inbound_Outbound_Movements_Interface* inboundOutboundMovements = (_Inbound_Outbound_Movements_Interface*)Allocate<_Inbound_Outbound_Movements_Interface::Component_Type>();
				...
				define_container_and_value_interface(_Activity_Locations_Container_Interface, _Activity_Location_Interface, get_type_of(activity_locations_container), Random_Access_Sequence_Prototype, Activity_Location_Prototype, ComponentType);

				activity_locations_container<_Activity_Locations_Container_Interface&>().clear();
				
				_Activity_Location_Interface* activity_location_0 = (_Activity_Location_Interface*)Allocate<_Activity_Location_Interface::Component_Type>();
				_Activity_Location_Interface* activity_location_1 = (_Activity_Location_Interface*)Allocate<_Activity_Location_Interface::Component_Type>();
				_Activity_Location_Interface* activity_location_2 = (_Activity_Location_Interface*)Allocate<_Activity_Location_Interface::Component_Type>();
			...
			feature_prototype void simulation_initialize(void* scenario_data)
			{
				...
				define_container_and_value_interface(_Vehicles_Container_Interface, _Vehicle_Interface, _Link_Interface::get_type_of(link_origin_vehicle_array), Random_Access_Sequence_Prototype, Vehicle_Prototype, ComponentType);
				typename _Links_Container_Interface::iterator links_itr;
				int i, j;
				for (links_itr = links_container<_Links_Container_Interface&>().begin(); links_itr != links_container<_Links_Container_Interface&>().end(); links_itr++)
				{
				...
				define_container_and_value_interface(_Intersections_Container_Interface, _Intersection_Interface, get_type_of(intersections_container), Random_Access_Sequence_Prototype, Intersection_Prototype, ComponentType);
				define_container_and_value_interface(_Outbound_Inbound_Movements_Container_Interface, _Outbound_Inbound_Movements_Interface, _Intersection_Interface::get_type_of(outbound_inbound_movements), Random_Access_Sequence_Prototype, Outbound_Inbound_Movements_Prototype, ComponentType);
				define_container_and_value_interface(_Inbound_Movements_Container_Interface, _Inbound_Movement_Interface, _Outbound_Inbound_Movements_Interface::get_type_of(inbound_movements), Random_Access_Sequence_Prototype, Movement_Prototype, ComponentType);
				...
				define_simple_container_interface(_Int_Container_Interface, _Inbound_Movement_Interface::get_type_of(cached_turn_movement_cumulative_shifted_arrived_vehicles_array), Random_Access_Sequence_Prototype, int, ComponentType);

				for (i = 0; i < (int)intersections_container<_Intersections_Container_Interface&>().size(); i++)
				{
					_Intersection_Interface* intersection = (_Intersection_Interface*)intersections_container<_Intersections_Container_Interface&>()[i];

					(intersection->rng_stream<_Intersection_Interface::get_type_of(rng_stream)&>()).SetSeed(((_Scenario_Interface*)scenario_data)->iseed<unsigned int>()+intersection->uuid<int>()+1);
			...
			feature_prototype void construct_routable_network()
			{
				...
				define_container_and_value_interface(_Routable_Networks_Container_Interface, _Routable_Network_Interface, get_type_of(routable_networks_container), Random_Access_Sequence_Prototype, Routable_Network_Prototype, ComponentType);
				...
				{
					_Routable_Network_Interface* routable_network = (_Routable_Network_Interface*)Allocate<_Routable_Network_Interface::Component_Type>();
