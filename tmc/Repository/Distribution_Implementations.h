...
namespace Distributions
{
	...
	{
		implementation struct Normal_Distribution_Implementation : public Polaris_Component<APPEND_CHILD(Normal_Distribution_Implementation),MasterType,ParentType>
		{
			feature_implementation TargetType Probability_Density_Value(TargetType x, TargetType mean=0.0, TargetType std=1.0, TargetType shape=0.0)
			{
			...
			feature_implementation TargetType Cumulative_Distribution_Value(TargetType x, TargetType mean=0.0, TargetType std=1.0, TargetType shape=0.0)
			{
				double x_std = ( (double)x - (double)mean ) / (double)std;
