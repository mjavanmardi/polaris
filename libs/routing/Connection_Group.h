...
namespace polaris
{
	...
	struct Anonymous_Connection_Group
	{
		...
		virtual Anonymous_Connection_Group* Visit_Neighbors(Tree_Agent<typename MasterType::tree_agent_type>* agent, void* current, Routing_Data<Base_Edge_Type>& routing_data) = 0;
	};
