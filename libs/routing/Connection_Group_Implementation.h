...
namespace polaris
{
	...
	struct Connection_Group_Base : public Anonymous_Connection_Group< MasterType, typename Current_Graph_Type::base_edge_type >
	{
		...
		virtual mAnonymous_Connection_Group* Visit_Transit_Neighbors(Routable_Agent<typename MasterType::routable_agent_type>* agent, void* current, Routing_Data<base_edge_type>& routing_data)
		{
			return this_component()->Visit_Transit_Neighbors(agent, (current_edge_type*)current, routing_data);
		};
