			...
			bool Validate_Control(stringstream& err_string)
			{
				...
				for (_Inbound_Outbound_Movements_Container_Interface::iterator io_itr = inbound_outbound_container.begin(); io_itr != inbound_outbound_container.end(); ++io_itr)
				{
					...
					for (_Outbound_Movements_Container_Interface::iterator mvmt_itr = movements.begin(); mvmt_itr != movements.end(); ++mvmt_itr)
					{
						...
						if (movement->template inbound_link<_Link_Interface*>()->template link_type<Link_Components::Types::Link_Type_Keys>() == Link_Components::Types::Link_Type_Keys::WALK || movement->template inbound_link<_Link_Interface*>()->template link_type<Link_Components::Types::Link_Type_Keys>() == Link_Components::Types::Link_Type_Keys::TRANSIT || movement->template inbound_link<_Link_Interface*>()->template link_type<Link_Components::Types::Link_Type_Keys>() == Link_Components::Types::Link_Type_Keys::RAIL || movement->template outbound_link<_Link_Interface*>()->template link_type<Link_Components::Types::Link_Type_Keys>() == Link_Components::Types::Link_Type_Keys::WALK || movement->template outbound_link<_Link_Interface*>()->template link_type<Link_Components::Types::Link_Type_Keys>() == Link_Components::Types::Link_Type_Keys::TRANSIT || movement->template outbound_link<_Link_Interface*>()->template link_type<Link_Components::Types::Link_Type_Keys>() == Link_Components::Types::Link_Type_Keys::RAIL)
						{
							continue;
						}
