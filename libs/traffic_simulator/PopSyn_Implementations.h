...
namespace PopSyn
{
	...
	{
		implementation struct ADAPTS_Population_Synthesis_Implementation : public Polaris_Component< MasterType,INHERIT(ADAPTS_Population_Synthesis_Implementation), Execution_Object, ParentType>
		{
			...
			m_prototype(Null_Prototype<typename MasterType::IPF_Solver_Settings>,Solution_Settings, NONE, NONE);
