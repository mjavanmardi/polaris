...
public:
	...
	/** Initializer*/
	static void Init_Linker(boost::container::vector<int> &dim_sizes, string link_file_path);
	static void Read_Linker_File(boost::container::vector<int> &dim_sizes);
	...
	static const boost::container::vector<int>& get_pums_data_cols(){return _pums_file_data_cols;}
	static const boost::container::vector<int>& get_person_data_cols(){return _person_file_data_cols;}
...
private:
	static boost::container::vector<vector<High_Low>> _ranges;
	static boost::container::vector<int> _pums_file_link;
	static boost::container::vector<vector<int>> _sf3_file_link;
//	static File_IO::File_Reader _fr;
	static string marg_file_path;
	static string sample_file_path;
	static boost::container::vector<int> _pums_file_data_cols;

	static string person_sample_file_path;
	static boost::container::vector<int> _person_file_data_cols;
};
...
boost::container::vector<int> Linker::_pums_file_link;
boost::container::vector<int> Linker::_pums_file_data_cols;
boost::container::vector<int> Linker::_person_file_data_cols;

boost::container::vector<vector<High_Low>> Linker::_ranges;
boost::container::vector<vector<int>> Linker::_sf3_file_link;
...
void Linker::Init_Linker(boost::container::vector<int> &dim_sizes, string link_file_path)
{
	zone_id_col =-1;
	region_id_col=-1;
...
void Linker::Read_Linker_File(boost::container::vector<int> &dim_sizes)
{
