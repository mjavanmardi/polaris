	...
	namespace Types
	{
		...
		struct File_Scenario{};
			...
			enum Demand_Sub_Iteration_keys
			{
				...
				ACTIVITY_GENERATION_SUB_ITERATION = 28,
				ACTIVITY_PLANNING_SUB_ITERATION,
				MOVEMENT_PLANNING_SUB_ITERATION
				//-------------------------------------------------------
			};
			enum Transit_Sub_Iteration_keys
			{
				TRANSIT_VEHICLE_ARRIVING_SUBITERATION = 19,
				TRAVELER_ARRIVING_SUBITERATION,
				TRANSIT_VEHICLE_ALIGHTING_SUBITERATION,				
				TRAVELER_WAITING_SUBITERATION,
				TRANSIT_VEHICLE_SEATING_SUBITERTION,
				TRAVELER_BOARDING_SUBITERATION,
				TRANSIT_VEHICLE_BOARDING_SUBITERTION,
				TRAVELER_REROUTING_SUBITERATION,
				TRANSIT_VEHICLE_DEPARTING_SUBITERATION,
				TRAVELER_MOVING_SUBITERATION,
				TRANSIT_VEHICLE_DEPOT_SUBITERATION
			};
			enum RNG_Type_Keys
			{
				DETERMINISTIC = 0,
