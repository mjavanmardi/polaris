...
namespace PopSyn
{
	...
	{
		implementation struct ADAPTS_Population_Unit_Implementation : public Polaris_Component< MasterType,INHERIT(ADAPTS_Population_Unit_Implementation), Data_Object, ParentType>
		{
			//=================================================================
