...
namespace PopSyn
{
	...
	namespace Concepts
	{
		...
		{
			check_accessor_name(has_ipf_tolerance_p, Component_Type::ipf_tolerance);
			check_accessor_name(has_marginal_tolerance_p, Component_Type::marginal_tolerance);
			check_accessor_name(has_maximum_iterations_p, Component_Type::maximum_iterations);
		...
		concept struct Scenario_Has_Popsyn_Configuration_Data
		{
			...
			check_accessor_name(has_percent_to_synthesize_p, Component_Type::percent_to_synthesize);
			check_accessor_name(has_write_marginal_output_p, Component_Type::write_marginal_output);
			check_accessor_name(has_write_full_output_p, Component_Type::write_full_output);
			check_accessor_name(has_popsyn_control_file_name_p, Component_Type::popsyn_control_file_name);
		...
		{
			check_accessor_name(Has_Target_Joint_Distribution_P,Component_Type::Target_Joint_Distribution);
			check_accessor_name(Has_Target_Marginal_Distribution_P,Component_Type::Target_Marginal_Distribution);
			check_accessor_name(Has_Synthetic_Households_Container_P,Component_Type::Synthetic_Households_Container);
			check_accessor_name(Has_Activity_Locations_Container_P,Component_Type::Activity_Locations_Container);
			check_accessor_name(Has_scenario_reference_P, Component_Type::scenario_reference);
			check_accessor_name(Has_network_reference_P, Component_Type::network_reference);
