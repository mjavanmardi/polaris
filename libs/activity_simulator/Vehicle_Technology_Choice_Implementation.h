	...
	namespace Implementations
	{
		...
		implementation struct UIC_Vehicle_Technology_Chooser_Implementation : public Polaris_Component<MasterType, INHERIT(UIC_Vehicle_Technology_Chooser_Implementation), Data_Object>
		{
			...
			static bool static_initialize(const string& option_file)
			{
				...
				scenario->set_parameter<float>(document, section, "CONSTANT", _CONSTANT);
				scenario->set_parameter<float>(document, section, "STD_CONSTANT", _STD_CONSTANT);
				scenario->set_parameter<float>(document, section, "B_JOB_ADMIN", _B_JOB_ADMIN);
				scenario->set_parameter<float>(document, section, "STD_JOB_ADMIN", _STD_JOB_ADMIN);
				scenario->set_parameter<float>(document, section, "T_INCOME_HIGH", _T_INCOME_HIGH);
				scenario->set_parameter<float>(document, section, "B_HAS_VEHICLE", _B_HAS_VEHICLE);
				scenario->set_parameter<float>(document, section, "STD_HAS_VEHICLE", _STD_HAS_VEHICLE);
				scenario->set_parameter<float>(document, section, "B_LONG_DISTANCE_TRIPS", _B_LONG_DISTANCE_TRIPS);
				scenario->set_parameter<float>(document, section, "STD_LONG_DISTANCE_TRIPS", _STD_LONG_DISTANCE_TRIPS);
				scenario->set_parameter<float>(document, section, "B_HAD_MAJOR_ACCIDENT", _B_HAD_MAJOR_ACCIDENT);
				scenario->set_parameter<float>(document, section, "STD_MAJOR_ACCIDENT", _STD_MAJOR_ACCIDENT);
				scenario->set_parameter<float>(document, section, "B_NO_TELECOMMUTE", _B_NO_TELECOMMUTE);
				scenario->set_parameter<float>(document, section, "STD_NO_TELECOMMUTE", _STD_NO_TELECOMMUTE);
				scenario->set_parameter<float>(document, section, "B_FUEL_EFFICIENCY_EXP_IMP", _B_FUEL_EFFICIENCY_EXP_IMP);
				scenario->set_parameter<float>(document, section, "STD_FUEL_EFFICIENCY_EXP_IMP", _STD_FUEL_EFFICIENCY_EXP_IMP);
				scenario->set_parameter<float>(document, section, "B_LESS_STRESSFUL_EXP", _B_LESS_STRESSFUL_EXP);
				scenario->set_parameter<float>(document, section, "STD_LESS_STRESSFUL_EXP", _STD_LESS_STRESSFUL_EXP);
				scenario->set_parameter<float>(document, section, "B_IMPERFECT_PERFORMANCE_EXP_IMP", _B_IMPERFECT_PERFORMANCE_EXP_IMP);
				scenario->set_parameter<float>(document, section, "T_INCREASE_SAFETY_EXP_IMP", _T_INCREASE_SAFETY_EXP_IMP);
				scenario->set_parameter<float>(document, section, "B_HIGH_PRICE_EXP_IMP", _B_HIGH_PRICE_EXP_IMP);
				scenario->set_parameter<float>(document, section, "STD_HIGH_PRICE_EXP_IMP", _STD_HIGH_PRICE_EXP_IMP);
				scenario->set_parameter<float>(document, section, "B_TRANSIT_ACCESSIBLE", _B_TRANSIT_ACCESSIBLE);
				scenario->set_parameter<float>(document, section, "B_LN_VMT", _B_LN_VMT);
				scenario->set_parameter<float>(document, section, "STD_LN_VMT", _STD_LN_VMT);
				scenario->set_parameter<float>(document, section, "B_WANTS_AV_TO_WORK", _B_WANTS_AV_TO_WORK);
				scenario->set_parameter<float>(document, section, "STD_WANTS_AV_TO_WORK", _STD_WANTS_AV_TO_WORK);
				scenario->set_parameter<float>(document, section, "B_FACTOR_ADVANCED_MOBILITY", _B_FACTOR_ADVANCED_MOBILITY);
				scenario->set_parameter<float>(document, section, "STD_FACTOR_ADVANCED_MOBILITY", _STD_FACTOR_ADVANCED_MOBILITY);
				scenario->set_parameter<float>(document, section, "B_FACTOR_ENJOY_DRIVE", _B_FACTOR_ENJOY_DRIVE);
				scenario->set_parameter<float>(document, section, "STD_FACTOR_ENJOY_DRIVE", _STD_FACTOR_ENJOY_DRIVE);
				scenario->set_parameter<float>(document, section, "B_FACTOR_PUBLIC_TRANSIT", _B_FACTOR_PUBLIC_TRANSIT);
				scenario->set_parameter<float>(document, section, "STD_FACTOR_PUBLIC_TRANSIT", _STD_FACTOR_PUBLIC_TRANSIT);
				scenario->set_parameter<float>(document, section, "B_FACTOR_ENVIRONMENTAL", _B_FACTOR_ENVIRONMENTAL);
				scenario->set_parameter<float>(document, section, "STD_FACTOR_ENVIRONMENT", _STD_FACTOR_ENVIRONMENT);
				scenario->set_parameter<float>(document, section, "MU_1", _MU_1);
				scenario->set_parameter<float>(document, section, "MU_1_STD", _MU_1_STD);
				scenario->set_parameter<float>(document, section, "MU_2", _MU_2);
				scenario->set_parameter<float>(document, section, "MU_2_STD", _MU_2_STD);
				scenario->set_parameter<float>(document, section, "MU_3", _MU_3);
				scenario->set_parameter<float>(document, section, "MU_3_STD", _MU_3_STD);
				scenario->set_parameter<float>(document, section, "MU_4", _MU_4);
				scenario->set_parameter<float>(document, section, "MU_4_STD", _MU_4_STD);
				scenario->set_parameter<float>(document, section, "EXPECT_FUEL_EFFICIENCY_AVG", _EXPECT_FUEL_EFFICIENCY_AVG);
				scenario->set_parameter<float>(document, section, "EXPECT_LESS_STRESSFUL_AVG", _EXPECT_LESS_STRESSFUL_AVG);
				scenario->set_parameter<float>(document, section, "EXPECT_INCREASED_SAFETY_AVG", _EXPECT_INCREASED_SAFETY_AVG);
				scenario->set_parameter<float>(document, section, "EXPECT_IMPERFECT_PERFORMANCE_AVG", _EXPECT_IMPERFECT_PERFORMANCE_AVG);
				scenario->set_parameter<float>(document, section, "EXPECT_CONTROL_FAILURE_AVG", _EXPECT_CONTROL_FAILURE_AVG);
				scenario->set_parameter<float>(document, section, "EXPECT_HIGH_PRICE_AVG", _EXPECT_HIGH_PRICE_AVG);
				scenario->set_parameter<float>(document, section, "EXPECT_PRIVACY_BREACH", _EXPECT_PRIVACY_BREACH);
				scenario->set_parameter<float>(document, section, "FACTOR_ADVANCED_MOBILITY_AVG", _FACTOR_ADVANCED_MOBILITY_AVG);
				scenario->set_parameter<float>(document, section, "FACTOR_DRIVE_THRILL_AVG", _FACTOR_DRIVE_THRILL_AVG);
				scenario->set_parameter<float>(document, section, "FACTOR_TRANSIT_AVG", _FACTOR_TRANSIT_AVG);
				scenario->set_parameter<float>(document, section, "FACTOR_ENVIRONMENT_AVG", _FACTOR_ENVIRONMENT_AVG);
				scenario->set_parameter<float>(document, section, "FACTOR_ADVANCED_MOBILITY_STD", _FACTOR_ADVANCED_MOBILITY_STD);
				scenario->set_parameter<float>(document, section, "FACTOR_DRIVE_THRILL_STD", _FACTOR_DRIVE_THRILL_STD);
				scenario->set_parameter<float>(document, section, "FACTOR_TRANSIT_STD", _FACTOR_TRANSIT_STD);
				scenario->set_parameter<float>(document, section, "FACTOR_ENVIRONMENT_STD", _FACTOR_ENVIRONMENT_STD);
