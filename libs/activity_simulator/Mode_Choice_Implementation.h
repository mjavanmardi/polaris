...
#pragma endregion
		...
		implementation struct ADAPTS_Mode_Choice_Option : public Choice_Model_Components::Implementations::Nested_Choice_Option_Base<MasterType, INHERIT(ADAPTS_Mode_Choice_Option)>
		{
			...
			static bool static_initialize(const string& option_file)
			{
				...
				scenario->set_parameter<float>(document, section, "HBW_ASC_AUTO"		, _HBW_ASC_AUTO			);
				scenario->set_parameter<float>(document, section, "HBO_ASC_AUTO"		, _HBO_ASC_AUTO			);
				scenario->set_parameter<float>(document, section, "NHB_ASC_AUTO"		, _NHB_ASC_AUTO			);
				scenario->set_parameter<float>(document, section, "HBW_ASC_PASS"		, _HBW_ASC_PASS			);
				scenario->set_parameter<float>(document, section, "HBO_ASC_PASS"		, _HBO_ASC_PASS			);
				scenario->set_parameter<float>(document, section, "NHB_ASC_PASS"		, _NHB_ASC_PASS			);
				scenario->set_parameter<float>(document, section, "HBW_ASC_TAXI"		, _HBW_ASC_TAXI			);
				scenario->set_parameter<float>(document, section, "HBO_ASC_TAXI"		, _HBO_ASC_TAXI			);
				scenario->set_parameter<float>(document, section, "NHB_ASC_TAXI"		, _NHB_ASC_TAXI			);
				scenario->set_parameter<float>(document, section, "HBW_ASC_WALK"		, _HBW_ASC_WALK			);
				scenario->set_parameter<float>(document, section, "HBO_ASC_WALK"		, _HBO_ASC_WALK			);
				scenario->set_parameter<float>(document, section, "NHB_ASC_WALK"		, _NHB_ASC_WALK			);
				scenario->set_parameter<float>(document, section, "HBW_ASC_TRAN"		, _HBW_ASC_TRAN			);
				scenario->set_parameter<float>(document, section, "HBO_ASC_TRAN"		, _HBO_ASC_TRAN			);
				scenario->set_parameter<float>(document, section, "NHB_ASC_TRAN"		, _NHB_ASC_TRAN			);
				scenario->set_parameter<float>(document, section, "HBW_ASC_BIKE"		, _HBW_ASC_BIKE			);
				scenario->set_parameter<float>(document, section, "HBO_ASC_BIKE"		, _HBO_ASC_BIKE			);
				scenario->set_parameter<float>(document, section, "NHB_ASC_BIKE"		, _NHB_ASC_BIKE			);
				scenario->set_parameter<float>(document, section, "HBW_B_cbd_pa"		, _HBW_B_cbd_pa			);
				scenario->set_parameter<float>(document, section, "HBO_B_cbd_pa"		, _HBO_B_cbd_pa			);
				scenario->set_parameter<float>(document, section, "NHB_B_cbd_pa"		, _NHB_B_cbd_pa			);
				scenario->set_parameter<float>(document, section, "HBW_B_cost"			, _HBW_B_cost			);
				scenario->set_parameter<float>(document, section, "HBO_B_cost"			, _HBO_B_cost			);
				scenario->set_parameter<float>(document, section, "NHB_B_cost"			, _NHB_B_cost			);
				scenario->set_parameter<float>(document, section, "HBW_B_cost_hinc"	, _HBW_B_cost_hinc		);
				scenario->set_parameter<float>(document, section, "HBO_B_cost_hinc"	, _HBO_B_cost_hinc		);
				scenario->set_parameter<float>(document, section, "NHB_B_cost_hinc"	, _NHB_B_cost_hinc		);
				scenario->set_parameter<float>(document, section, "HBW_B_cost_minc"	, _HBW_B_cost_minc		);
				scenario->set_parameter<float>(document, section, "HBO_B_cost_minc"	, _HBO_B_cost_minc		);
				scenario->set_parameter<float>(document, section, "NHB_B_cost_minc"	, _NHB_B_cost_minc		);
				scenario->set_parameter<float>(document, section, "HBW_B_dens_bike"	, _HBW_B_dens_bike		);
				scenario->set_parameter<float>(document, section, "HBO_B_dens_bike"	, _HBO_B_dens_bike		);
				scenario->set_parameter<float>(document, section, "NHB_B_dens_bike"	, _NHB_B_dens_bike		);
				scenario->set_parameter<float>(document, section, "HBW_B_dens_walk"	, _HBW_B_dens_walk		);
				scenario->set_parameter<float>(document, section, "HBO_B_dens_walk"	, _HBO_B_dens_walk		);
				scenario->set_parameter<float>(document, section, "NHB_B_dens_walk"	, _NHB_B_dens_walk		);
				scenario->set_parameter<float>(document, section, "HBW_B_male_taxi"	, _HBW_B_male_taxi		);
				scenario->set_parameter<float>(document, section, "HBO_B_male_taxi"	, _HBO_B_male_taxi		);
				scenario->set_parameter<float>(document, section, "NHB_B_male_taxi"	, _NHB_B_male_taxi		);
				scenario->set_parameter<float>(document, section, "HBW_B_notalone_pass", _HBW_B_notalone_pass	);
				scenario->set_parameter<float>(document, section, "HBO_B_notalone_pass", _HBO_B_notalone_pass	);
				scenario->set_parameter<float>(document, section, "NHB_B_notalone_pass", _NHB_B_notalone_pass	);
				scenario->set_parameter<float>(document, section, "HBW_B_over65_pass"	, _HBW_B_over65_pass	);
				scenario->set_parameter<float>(document, section, "HBO_B_over65_pass"	, _HBO_B_over65_pass	);
				scenario->set_parameter<float>(document, section, "NHB_B_over65_pass"	, _NHB_B_over65_pass 	);
				scenario->set_parameter<float>(document, section, "HBW_B_over65_tran"	, _HBW_B_over65_tran	);
				scenario->set_parameter<float>(document, section, "HBO_B_over65_tran"	, _HBO_B_over65_tran	);
				scenario->set_parameter<float>(document, section, "NHB_B_over65_tran"	, _NHB_B_over65_tran 	);
				scenario->set_parameter<float>(document, section, "HBW_B_ovttime_tran"	, _HBW_B_ovttime_tran	);
				scenario->set_parameter<float>(document, section, "HBO_B_ovttime_tran"	, _HBO_B_ovttime_tran	);
				scenario->set_parameter<float>(document, section, "NHB_B_ovttime_tran"	, _NHB_B_ovttime_tran	);
				scenario->set_parameter<float>(document, section, "HBW_B_peak_auto"	, _HBW_B_peak_auto   	);
				scenario->set_parameter<float>(document, section, "HBO_B_peak_auto"	, _HBO_B_peak_auto   	);
				scenario->set_parameter<float>(document, section, "NHB_B_peak_auto"	, _NHB_B_peak_auto   	);
				scenario->set_parameter<float>(document, section, "HBW_B_ttime_bike"	, _HBW_B_ttime_bike		);
				scenario->set_parameter<float>(document, section, "HBO_B_ttime_bike"	, _HBO_B_ttime_bike		);
				scenario->set_parameter<float>(document, section, "NHB_B_ttime_bike"	, _NHB_B_ttime_bike  	);
				scenario->set_parameter<float>(document, section, "HBW_B_ttime_tran"	, _HBW_B_ttime_tran		);
				scenario->set_parameter<float>(document, section, "HBO_B_ttime_tran"	, _HBO_B_ttime_tran		);
				scenario->set_parameter<float>(document, section, "NHB_B_ttime_tran"	, _NHB_B_ttime_tran  	);
				scenario->set_parameter<float>(document, section, "HBW_B_ttime_walk"	, _HBW_B_ttime_walk		);
				scenario->set_parameter<float>(document, section, "HBO_B_ttime_walk"	, _HBO_B_ttime_walk		);
				scenario->set_parameter<float>(document, section, "NHB_B_ttime_walk"	, _NHB_B_ttime_walk  	);
				scenario->set_parameter<float>(document, section, "HBW_B_u18_pass"		, _HBW_B_u18_pass		);
				scenario->set_parameter<float>(document, section, "HBO_B_u18_pass"		, _HBO_B_u18_pass		);
				scenario->set_parameter<float>(document, section, "NHB_B_u18_pass"		, _NHB_B_u18_pass    	);
				scenario->set_parameter<float>(document, section, "HBW_B_vehavail_pass", _HBW_B_vehavail_pass	);
				scenario->set_parameter<float>(document, section, "HBO_B_vehavail_pass", _HBO_B_vehavail_pass	);
				scenario->set_parameter<float>(document, section, "NHB_B_vehavail_pass", _NHB_B_vehavail_pass	);
				scenario->set_parameter<float>(document, section, "HBW_B_vehavail_taxi", _HBW_B_vehavail_taxi	);
				scenario->set_parameter<float>(document, section, "HBO_B_vehavail_taxi", _HBO_B_vehavail_taxi	);
				scenario->set_parameter<float>(document, section, "NHB_B_vehavail_taxi", _NHB_B_vehavail_taxi	);
				scenario->set_parameter<float>(document, section, "HBW_B_vehavail_tran", _HBW_B_vehavail_tran	);
				scenario->set_parameter<float>(document, section, "HBO_B_vehavail_tran", _HBO_B_vehavail_tran	);
				scenario->set_parameter<float>(document, section, "NHB_B_vehavail_tran", _NHB_B_vehavail_tran	);
				scenario->set_parameter<float>(document, section, "HBW_B_waittime_tran", _HBW_B_waittime_tran	);
				scenario->set_parameter<float>(document, section, "HBO_B_waittime_tran", _HBO_B_waittime_tran	);
				scenario->set_parameter<float>(document, section, "NHB_B_waittime_tran", _NHB_B_waittime_tran	);
				scenario->set_parameter<float>(document, section, "HBW_ASC_N_AUTO"		, _HBW_ASC_N_AUTO		);
				scenario->set_parameter<float>(document, section, "HBO_ASC_N_AUTO"		, _HBO_ASC_N_AUTO		);
				scenario->set_parameter<float>(document, section, "NHB_ASC_N_AUTO"		, _NHB_ASC_N_AUTO    	);
				scenario->set_parameter<float>(document, section, "HBW_ASC_N_NM"		, _HBW_ASC_N_NM			);
				scenario->set_parameter<float>(document, section, "HBO_ASC_N_NM"		, _HBO_ASC_N_NM			);
				scenario->set_parameter<float>(document, section, "NHB_ASC_N_NM"		, _NHB_ASC_N_NM      	);
				scenario->set_parameter<float>(document, section, "HBW_B_vehavail_nm"	, _HBW_B_vehavail_nm	);
				scenario->set_parameter<float>(document, section, "HBO_B_vehavail_nm"	, _HBO_B_vehavail_nm	);
				scenario->set_parameter<float>(document, section, "NHB_B_vehavail_nm"	, _NHB_B_vehavail_nm 	);
				scenario->set_parameter<float>(document, section, "HBW_B_male_nm"		, _HBW_B_male_nm		);
				scenario->set_parameter<float>(document, section, "HBO_B_male_nm"		, _HBO_B_male_nm		);
				scenario->set_parameter<float>(document, section, "NHB_B_male_nm"		, _NHB_B_male_nm     	);
				scenario->set_parameter<float>(document, section, "HBW_B_cbd_nm"		, _HBW_B_cbd_nm			);
				scenario->set_parameter<float>(document, section, "HBO_B_cbd_nm"		, _HBO_B_cbd_nm			);
				scenario->set_parameter<float>(document, section, "NHB_B_cbd_nm"		, _NHB_B_cbd_nm      	);
				scenario->set_parameter<float>(document, section, "HBW_NEST_AUTO"		, _HBW_NEST_AUTO		);
				scenario->set_parameter<float>(document, section, "HBO_NEST_AUTO"		, _HBO_NEST_AUTO		);
				scenario->set_parameter<float>(document, section, "NHB_NEST_AUTO"		, _NHB_NEST_AUTO     	);
				scenario->set_parameter<float>(document, section, "HBW_NEST_NM"		, _HBW_NEST_NM	    	);
				scenario->set_parameter<float>(document, section, "HBO_NEST_NM"		, _HBO_NEST_NM	    	);
				scenario->set_parameter<float>(document, section, "NHB_NEST_NM"		, _NHB_NEST_NM       	);
