...
namespace Person_Components
{
	namespace Implementations
	{
		...
		implementation struct General_Person_Perception_Implementation : public Polaris_Component<MasterType,INHERIT(General_Person_Perception_Implementation),Data_Object>
		{
			...
			typedef Network_Skimming_Components::Prototypes::Network_Skimming< typename Network_interface::get_type_of(skimming_faculty)> _Skim_Interface;
			typedef  Activity_Location_Components::Prototypes::Activity_Location<typename remove_pointer< typename Network_interface::get_type_of(activity_locations_container)::value_type>::type>  _Activity_Location_Interface;
			typedef  Random_Access_Sequence< typename Network_interface::get_type_of(activity_locations_container), _Activity_Location_Interface*> _Activity_Locations_Container_Interface;
			...
			typedef  Pair_Associative_Container< typename Network_interface::get_type_of(zones_container), _Zone_Interface*> _Zones_Container_Interface;
