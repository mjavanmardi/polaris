...
namespace Person_Components
{
	namespace Implementations
	{
		...
		implementation struct General_Person_Scheduler_Implementation : public Polaris_Component<MasterType,INHERIT(General_Person_Scheduler_Implementation),Execution_Object>
		{
			...
			//RLW%%% typedef Activity_Components::Prototypes::Activity_Planner<get_component_type(Activity_Plans)> Activity_Plan;
			typedef Activity_Components::Prototypes::Activity_Planner<typename Activity_Plans::value_type> Activity_Plan;
