	...
	namespace Implementations
	{
		...
		implementation struct ADAPTS_Destination_Choice_Option : public Choice_Model_Components::Implementations::Choice_Option_Base<MasterType,INHERIT(ADAPTS_Destination_Choice_Option)>
		{
			...
			static bool static_initialize(const string& option_file)
			{
				...
				scenario->set_parameter(document, section, "BTT_PICK"   , _BTT_PICK	  	);
				scenario->set_parameter(document, section, "BINCD_PICK" , _BINCD_PICK 	);
				scenario->set_parameter(document, section, "BRACED_PICK", _BRACED_PICK	);
				scenario->set_parameter(document, section, "BArRes_PICK", _BArRes_PICK	);
				scenario->set_parameter(document, section, "BArRec_PICK", _BArRec_PICK	);
				scenario->set_parameter(document, section, "BArRet_PICK", _BArRet_PICK	);
				scenario->set_parameter(document, section, "BArEnt_PICK", _BArEnt_PICK	);
				scenario->set_parameter(document, section, "BArIns_PICK", _BArIns_PICK	);
				scenario->set_parameter(document, section, "BArOff_PICK", _BArOff_PICK	);
				scenario->set_parameter(document, section, "BArMix_PICK", _BArMix_PICK	);
				scenario->set_parameter(document, section, "BArSch_PICK", _BArSch_PICK	);
				scenario->set_parameter(document, section, "BEmOth_PICK", _BEmOth_PICK	);
				scenario->set_parameter(document, section, "BEmInd_PICK", _BEmInd_PICK	);
				scenario->set_parameter(document, section, "BEmGov_PICK", _BEmGov_PICK	);
				scenario->set_parameter(document, section, "BEmSer_PICK", _BEmSer_PICK	);
				scenario->set_parameter(document, section, "BEmMan_PICK", _BEmMan_PICK	);
				scenario->set_parameter(document, section, "BEmRet_PICK", _BEmRet_PICK	);
				scenario->set_parameter(document, section, "THETAG_PICK", _THETAG_PICK	);
				scenario->set_parameter(document, section, "THETAM_PICK", _THETAM_PICK	);
				scenario->set_parameter(document, section, "THETAR_PICK", _THETAR_PICK	);
				scenario->set_parameter(document, section, "THETAS_PICK", _THETAS_PICK	);
				scenario->set_parameter(document, section, "THETAI_PICK", _THETAI_PICK	);
				scenario->set_parameter(document, section, "THETAO_PICK", _THETAO_PICK	);
				scenario->set_parameter(document, section, "GAMMA_PICK" , _GAMMA_PICK 	);

				scenario->set_parameter(document, section, "BTT_OTHER_WORK"	  , _BTT_OTHER_WORK		);
				scenario->set_parameter(document, section, "BINCD_OTHER_WORK" , _BINCD_OTHER_WORK	);
				scenario->set_parameter(document, section, "BRACED_OTHER_WORK", _BRACED_OTHER_WORK	);
				scenario->set_parameter(document, section, "BArRes_OTHER_WORK", _BArRes_OTHER_WORK	);
				scenario->set_parameter(document, section, "BArRec_OTHER_WORK", _BArRec_OTHER_WORK	);
				scenario->set_parameter(document, section, "BArRet_OTHER_WORK", _BArRet_OTHER_WORK	);
				scenario->set_parameter(document, section, "BArEnt_OTHER_WORK", _BArEnt_OTHER_WORK	);
				scenario->set_parameter(document, section, "BArIns_OTHER_WORK", _BArIns_OTHER_WORK	);
				scenario->set_parameter(document, section, "BArOff_OTHER_WORK", _BArOff_OTHER_WORK	);
				scenario->set_parameter(document, section, "BArMix_OTHER_WORK", _BArMix_OTHER_WORK	);
				scenario->set_parameter(document, section, "BArSch_OTHER_WORK", _BArSch_OTHER_WORK	);
				scenario->set_parameter(document, section, "BEmOth_OTHER_WORK", _BEmOth_OTHER_WORK	);
				scenario->set_parameter(document, section, "BEmInd_OTHER_WORK", _BEmInd_OTHER_WORK	);
				scenario->set_parameter(document, section, "BEmGov_OTHER_WORK", _BEmGov_OTHER_WORK	);
				scenario->set_parameter(document, section, "BEmSer_OTHER_WORK", _BEmSer_OTHER_WORK	);
				scenario->set_parameter(document, section, "BEmMan_OTHER_WORK", _BEmMan_OTHER_WORK	);
				scenario->set_parameter(document, section, "BEmRet_OTHER_WORK", _BEmRet_OTHER_WORK	);
				scenario->set_parameter(document, section, "THETAG_OTHER_WORK", _THETAG_OTHER_WORK	);
				scenario->set_parameter(document, section, "THETAM_OTHER_WORK", _THETAM_OTHER_WORK	);
				scenario->set_parameter(document, section, "THETAR_OTHER_WORK", _THETAR_OTHER_WORK	);
				scenario->set_parameter(document, section, "THETAS_OTHER_WORK", _THETAS_OTHER_WORK	);
				scenario->set_parameter(document, section, "THETAI_OTHER_WORK", _THETAI_OTHER_WORK	);
				scenario->set_parameter(document, section, "THETAO_OTHER_WORK", _THETAO_OTHER_WORK	);
				scenario->set_parameter(document, section, "GAMMA_OTHER_WORK",  _GAMMA_OTHER_WORK 	);

				scenario->set_parameter(document, section, "BTT_SERVICE"   , _BTT_SERVICE		);
				scenario->set_parameter(document, section, "BINCD_SERVICE" , _BINCD_SERVICE		);
				scenario->set_parameter(document, section, "BRACED_SERVICE", _BRACED_SERVICE	);
				scenario->set_parameter(document, section, "BArRes_SERVICE", _BArRes_SERVICE	);
				scenario->set_parameter(document, section, "BArRec_SERVICE", _BArRec_SERVICE	);
				scenario->set_parameter(document, section, "BArRet_SERVICE", _BArRet_SERVICE	);
				scenario->set_parameter(document, section, "BArEnt_SERVICE", _BArEnt_SERVICE	);
				scenario->set_parameter(document, section, "BArIns_SERVICE", _BArIns_SERVICE	);
				scenario->set_parameter(document, section, "BArOff_SERVICE", _BArOff_SERVICE	);
				scenario->set_parameter(document, section, "BArMix_SERVICE", _BArMix_SERVICE	);
				scenario->set_parameter(document, section, "BArSch_SERVICE", _BArSch_SERVICE	);
				scenario->set_parameter(document, section, "BEmOth_SERVICE", _BEmOth_SERVICE	);
				scenario->set_parameter(document, section, "BEmInd_SERVICE", _BEmInd_SERVICE	);
				scenario->set_parameter(document, section, "BEmGov_SERVICE", _BEmGov_SERVICE	);
				scenario->set_parameter(document, section, "BEmSer_SERVICE", _BEmSer_SERVICE	);
				scenario->set_parameter(document, section, "BEmMan_SERVICE", _BEmMan_SERVICE	);
				scenario->set_parameter(document, section, "BEmRet_SERVICE", _BEmRet_SERVICE	);
				scenario->set_parameter(document, section, "THETAG_SERVICE", _THETAG_SERVICE	);
				scenario->set_parameter(document, section, "THETAM_SERVICE", _THETAM_SERVICE	);
				scenario->set_parameter(document, section, "THETAR_SERVICE", _THETAR_SERVICE	);
				scenario->set_parameter(document, section, "THETAS_SERVICE", _THETAS_SERVICE	);
				scenario->set_parameter(document, section, "THETAI_SERVICE", _THETAI_SERVICE	);
				scenario->set_parameter(document, section, "THETAO_SERVICE", _THETAO_SERVICE	);
				scenario->set_parameter(document, section, "GAMMA_SERVICE" , _GAMMA_SERVICE		);

				scenario->set_parameter(document, section, "BTT_MIN_SHOP"	, _BTT_MIN_SHOP		);
				scenario->set_parameter(document, section, "BINCD_MIN_SHOP" , _BINCD_MIN_SHOP	);
				scenario->set_parameter(document, section, "BRACED_MIN_SHOP", _BRACED_MIN_SHOP	);
				scenario->set_parameter(document, section, "BArRes_MIN_SHOP", _BArRes_MIN_SHOP	);
				scenario->set_parameter(document, section, "BArRec_MIN_SHOP", _BArRec_MIN_SHOP	);
				scenario->set_parameter(document, section, "BArRet_MIN_SHOP", _BArRet_MIN_SHOP	);
				scenario->set_parameter(document, section, "BArEnt_MIN_SHOP", _BArEnt_MIN_SHOP	);
				scenario->set_parameter(document, section, "BArIns_MIN_SHOP", _BArIns_MIN_SHOP	);
				scenario->set_parameter(document, section, "BArOff_MIN_SHOP", _BArOff_MIN_SHOP	);
				scenario->set_parameter(document, section, "BArMix_MIN_SHOP", _BArMix_MIN_SHOP	);
				scenario->set_parameter(document, section, "BArSch_MIN_SHOP", _BArSch_MIN_SHOP	);
				scenario->set_parameter(document, section, "BEmOth_MIN_SHOP", _BEmOth_MIN_SHOP	);
				scenario->set_parameter(document, section, "BEmInd_MIN_SHOP", _BEmInd_MIN_SHOP	);
				scenario->set_parameter(document, section, "BEmGov_MIN_SHOP", _BEmGov_MIN_SHOP	);
				scenario->set_parameter(document, section, "BEmSer_MIN_SHOP", _BEmSer_MIN_SHOP	);
				scenario->set_parameter(document, section, "BEmMan_MIN_SHOP", _BEmMan_MIN_SHOP	);
				scenario->set_parameter(document, section, "BEmRet_MIN_SHOP", _BEmRet_MIN_SHOP	);
				scenario->set_parameter(document, section, "THETAG_MIN_SHOP", _THETAG_MIN_SHOP	);
				scenario->set_parameter(document, section, "THETAM_MIN_SHOP", _THETAM_MIN_SHOP	);
				scenario->set_parameter(document, section, "THETAR_MIN_SHOP", _THETAR_MIN_SHOP	);
				scenario->set_parameter(document, section, "THETAS_MIN_SHOP", _THETAS_MIN_SHOP	);
				scenario->set_parameter(document, section, "THETAI_MIN_SHOP", _THETAI_MIN_SHOP	);
				scenario->set_parameter(document, section, "THETAO_MIN_SHOP", _THETAO_MIN_SHOP	);
				scenario->set_parameter(document, section, "GAMMA_MIN_SHOP" , _GAMMA_MIN_SHOP 	);

				scenario->set_parameter(document, section, "BTT_MAJ_SHOP"   , _BTT_MAJ_SHOP   	);
				scenario->set_parameter(document, section, "BINCD_MAJ_SHOP" , _BINCD_MAJ_SHOP 	);
				scenario->set_parameter(document, section, "BRACED_MAJ_SHOP", _BRACED_MAJ_SHOP	);
				scenario->set_parameter(document, section, "BArRes_MAJ_SHOP", _BArRes_MAJ_SHOP	);
				scenario->set_parameter(document, section, "BArRec_MAJ_SHOP", _BArRec_MAJ_SHOP	);
				scenario->set_parameter(document, section, "BArRet_MAJ_SHOP", _BArRet_MAJ_SHOP	);
				scenario->set_parameter(document, section, "BArEnt_MAJ_SHOP", _BArEnt_MAJ_SHOP	);
				scenario->set_parameter(document, section, "BArIns_MAJ_SHOP", _BArIns_MAJ_SHOP	);
				scenario->set_parameter(document, section, "BArOff_MAJ_SHOP", _BArOff_MAJ_SHOP	);
				scenario->set_parameter(document, section, "BArMix_MAJ_SHOP", _BArMix_MAJ_SHOP	);
				scenario->set_parameter(document, section, "BArSch_MAJ_SHOP", _BArSch_MAJ_SHOP	);
				scenario->set_parameter(document, section, "BEmOth_MAJ_SHOP", _BEmOth_MAJ_SHOP	);
				scenario->set_parameter(document, section, "BEmInd_MAJ_SHOP", _BEmInd_MAJ_SHOP	);
				scenario->set_parameter(document, section, "BEmGov_MAJ_SHOP", _BEmGov_MAJ_SHOP	);
				scenario->set_parameter(document, section, "BEmSer_MAJ_SHOP", _BEmSer_MAJ_SHOP	);
				scenario->set_parameter(document, section, "BEmMan_MAJ_SHOP", _BEmMan_MAJ_SHOP	);
				scenario->set_parameter(document, section, "BEmRet_MAJ_SHOP", _BEmRet_MAJ_SHOP	);
				scenario->set_parameter(document, section, "THETAG_MAJ_SHOP", _THETAG_MAJ_SHOP	);
				scenario->set_parameter(document, section, "THETAM_MAJ_SHOP", _THETAM_MAJ_SHOP	);
				scenario->set_parameter(document, section, "THETAR_MAJ_SHOP", _THETAR_MAJ_SHOP	);
				scenario->set_parameter(document, section, "THETAS_MAJ_SHOP", _THETAS_MAJ_SHOP	);
				scenario->set_parameter(document, section, "THETAI_MAJ_SHOP", _THETAI_MAJ_SHOP	);
				scenario->set_parameter(document, section, "THETAO_MAJ_SHOP", _THETAO_MAJ_SHOP	);
				scenario->set_parameter(document, section, "GAMMA_MAJ_SHOP" , _GAMMA_MAJ_SHOP 	);

				scenario->set_parameter(document, section, "BTT_EAT_OUT"   , _BTT_EAT_OUT		);
				scenario->set_parameter(document, section, "BINCD_EAT_OUT" , _BINCD_EAT_OUT		);
				scenario->set_parameter(document, section, "BRACED_EAT_OUT", _BRACED_EAT_OUT	);
				scenario->set_parameter(document, section, "BArRes_EAT_OUT", _BArRes_EAT_OUT	);
				scenario->set_parameter(document, section, "BArRec_EAT_OUT", _BArRec_EAT_OUT	);
				scenario->set_parameter(document, section, "BArRet_EAT_OUT", _BArRet_EAT_OUT	);
				scenario->set_parameter(document, section, "BArEnt_EAT_OUT", _BArEnt_EAT_OUT	);
				scenario->set_parameter(document, section, "BArIns_EAT_OUT", _BArIns_EAT_OUT	);
				scenario->set_parameter(document, section, "BArOff_EAT_OUT", _BArOff_EAT_OUT	);
				scenario->set_parameter(document, section, "BArMix_EAT_OUT", _BArMix_EAT_OUT	);
				scenario->set_parameter(document, section, "BArSch_EAT_OUT", _BArSch_EAT_OUT	);
				scenario->set_parameter(document, section, "BEmOth_EAT_OUT", _BEmOth_EAT_OUT	);
				scenario->set_parameter(document, section, "BEmInd_EAT_OUT", _BEmInd_EAT_OUT	);
				scenario->set_parameter(document, section, "BEmGov_EAT_OUT", _BEmGov_EAT_OUT	);
				scenario->set_parameter(document, section, "BEmSer_EAT_OUT", _BEmSer_EAT_OUT	);
				scenario->set_parameter(document, section, "BEmMan_EAT_OUT", _BEmMan_EAT_OUT	);
				scenario->set_parameter(document, section, "BEmRet_EAT_OUT", _BEmRet_EAT_OUT	);
				scenario->set_parameter(document, section, "THETAG_EAT_OUT", _THETAG_EAT_OUT	);
				scenario->set_parameter(document, section, "THETAM_EAT_OUT", _THETAM_EAT_OUT	);
				scenario->set_parameter(document, section, "THETAR_EAT_OUT", _THETAR_EAT_OUT	);
				scenario->set_parameter(document, section, "THETAS_EAT_OUT", _THETAS_EAT_OUT	);
				scenario->set_parameter(document, section, "THETAI_EAT_OUT", _THETAI_EAT_OUT	);
				scenario->set_parameter(document, section, "THETAO_EAT_OUT", _THETAO_EAT_OUT	);
				scenario->set_parameter(document, section, "GAMMA_EAT_OUT", _GAMMA_EAT_OUT		);

				scenario->set_parameter(document, section, "BTT_CIVIC"   , _BTT_CIVIC   	);
				scenario->set_parameter(document, section, "BINCD_CIVIC" , _BINCD_CIVIC 	);
				scenario->set_parameter(document, section, "BRACED_CIVIC", _BRACED_CIVIC	);
				scenario->set_parameter(document, section, "BArRes_CIVIC", _BArRes_CIVIC	);
				scenario->set_parameter(document, section, "BArRec_CIVIC", _BArRec_CIVIC	);
				scenario->set_parameter(document, section, "BArRet_CIVIC", _BArRet_CIVIC	);
				scenario->set_parameter(document, section, "BArEnt_CIVIC", _BArEnt_CIVIC	);
				scenario->set_parameter(document, section, "BArIns_CIVIC", _BArIns_CIVIC	);
				scenario->set_parameter(document, section, "BArOff_CIVIC", _BArOff_CIVIC	);
				scenario->set_parameter(document, section, "BArMix_CIVIC", _BArMix_CIVIC	);
				scenario->set_parameter(document, section, "BArSch_CIVIC", _BArSch_CIVIC	);
				scenario->set_parameter(document, section, "BEmOth_CIVIC", _BEmOth_CIVIC	);
				scenario->set_parameter(document, section, "BEmInd_CIVIC", _BEmInd_CIVIC	);
				scenario->set_parameter(document, section, "BEmGov_CIVIC", _BEmGov_CIVIC	);
				scenario->set_parameter(document, section, "BEmSer_CIVIC", _BEmSer_CIVIC	);
				scenario->set_parameter(document, section, "BEmMan_CIVIC", _BEmMan_CIVIC	);
				scenario->set_parameter(document, section, "BEmRet_CIVIC", _BEmRet_CIVIC	);
				scenario->set_parameter(document, section, "THETAG_CIVIC", _THETAG_CIVIC	);
				scenario->set_parameter(document, section, "THETAM_CIVIC", _THETAM_CIVIC	);
				scenario->set_parameter(document, section, "THETAR_CIVIC", _THETAR_CIVIC	);
				scenario->set_parameter(document, section, "THETAS_CIVIC", _THETAS_CIVIC	);
				scenario->set_parameter(document, section, "THETAI_CIVIC", _THETAI_CIVIC	);
				scenario->set_parameter(document, section, "THETAO_CIVIC", _THETAO_CIVIC	);
				scenario->set_parameter(document, section, "GAMMA_CIVIC" , _GAMMA_CIVIC 	);

				scenario->set_parameter(document, section, "BTT_LEISURE"   , _BTT_LEISURE		);
				scenario->set_parameter(document, section, "BINCD_LEISURE" , _BINCD_LEISURE 	);
				scenario->set_parameter(document, section, "BRACED_LEISURE", _BRACED_LEISURE	);
				scenario->set_parameter(document, section, "BArRes_LEISURE", _BArRes_LEISURE	);
				scenario->set_parameter(document, section, "BArRec_LEISURE", _BArRec_LEISURE	);
				scenario->set_parameter(document, section, "BArRet_LEISURE", _BArRet_LEISURE	);
				scenario->set_parameter(document, section, "BArEnt_LEISURE", _BArEnt_LEISURE	);
				scenario->set_parameter(document, section, "BArIns_LEISURE", _BArIns_LEISURE	);
				scenario->set_parameter(document, section, "BArOff_LEISURE", _BArOff_LEISURE	);
				scenario->set_parameter(document, section, "BArMix_LEISURE", _BArMix_LEISURE	);
				scenario->set_parameter(document, section, "BArSch_LEISURE", _BArSch_LEISURE	);
				scenario->set_parameter(document, section, "BEmOth_LEISURE", _BEmOth_LEISURE	);
				scenario->set_parameter(document, section, "BEmInd_LEISURE", _BEmInd_LEISURE	);
				scenario->set_parameter(document, section, "BEmGov_LEISURE", _BEmGov_LEISURE	);
				scenario->set_parameter(document, section, "BEmSer_LEISURE", _BEmSer_LEISURE	);
				scenario->set_parameter(document, section, "BEmMan_LEISURE", _BEmMan_LEISURE	);
				scenario->set_parameter(document, section, "BEmRet_LEISURE", _BEmRet_LEISURE	);
				scenario->set_parameter(document, section, "THETAG_LEISURE", _THETAG_LEISURE	);
				scenario->set_parameter(document, section, "THETAM_LEISURE", _THETAM_LEISURE	);
				scenario->set_parameter(document, section, "THETAR_LEISURE", _THETAR_LEISURE	);
				scenario->set_parameter(document, section, "THETAS_LEISURE", _THETAS_LEISURE	);
				scenario->set_parameter(document, section, "THETAI_LEISURE", _THETAI_LEISURE	);
				scenario->set_parameter(document, section, "THETAO_LEISURE", _THETAO_LEISURE	);
				scenario->set_parameter(document, section, "GAMMA_LEISURE" , _GAMMA_LEISURE 	);

				scenario->set_parameter(document, section, "BTT_SOCIAL"   , _BTT_SOCIAL   	);
				scenario->set_parameter(document, section, "BINCD_SOCIAL" , _BINCD_SOCIAL 	);
				scenario->set_parameter(document, section, "BRACED_SOCIAL", _BRACED_SOCIAL	);
				scenario->set_parameter(document, section, "BArRes_SOCIAL", _BArRes_SOCIAL	);
				scenario->set_parameter(document, section, "BArRec_SOCIAL", _BArRec_SOCIAL	);
				scenario->set_parameter(document, section, "BArRet_SOCIAL", _BArRet_SOCIAL	);
				scenario->set_parameter(document, section, "BArEnt_SOCIAL", _BArEnt_SOCIAL	);
				scenario->set_parameter(document, section, "BArIns_SOCIAL", _BArIns_SOCIAL	);
				scenario->set_parameter(document, section, "BArOff_SOCIAL", _BArOff_SOCIAL	);
				scenario->set_parameter(document, section, "BArMix_SOCIAL", _BArMix_SOCIAL	);
				scenario->set_parameter(document, section, "BArSch_SOCIAL", _BArSch_SOCIAL	);
				scenario->set_parameter(document, section, "BEmOth_SOCIAL", _BEmOth_SOCIAL	);
				scenario->set_parameter(document, section, "BEmInd_SOCIAL", _BEmInd_SOCIAL	);
				scenario->set_parameter(document, section, "BEmGov_SOCIAL", _BEmGov_SOCIAL	);
				scenario->set_parameter(document, section, "BEmSer_SOCIAL", _BEmSer_SOCIAL	);
				scenario->set_parameter(document, section, "BEmMan_SOCIAL", _BEmMan_SOCIAL	);
				scenario->set_parameter(document, section, "BEmRet_SOCIAL", _BEmRet_SOCIAL	);
				scenario->set_parameter(document, section, "THETAG_SOCIAL", _THETAG_SOCIAL	);
				scenario->set_parameter(document, section, "THETAM_SOCIAL", _THETAM_SOCIAL	);
				scenario->set_parameter(document, section, "THETAR_SOCIAL", _THETAR_SOCIAL	);
				scenario->set_parameter(document, section, "THETAS_SOCIAL", _THETAS_SOCIAL	);
				scenario->set_parameter(document, section, "THETAI_SOCIAL", _THETAI_SOCIAL	);
				scenario->set_parameter(document, section, "THETAO_SOCIAL", _THETAO_SOCIAL	);
				scenario->set_parameter(document, section, "GAMMA_SOCIAL" , _GAMMA_SOCIAL 	);

				scenario->set_parameter(document, section, "BTT_OTHER"  , _BTT_OTHER		);
				scenario->set_parameter(document, section, "BINCD_OTHER", _BINCD_OTHER 		);
				scenario->set_parameter(document, section, "BRACED_OTHER", _BRACED_OTHER	);
				scenario->set_parameter(document, section, "BArRes_OTHER", _BArRes_OTHER	);
				scenario->set_parameter(document, section, "BArRec_OTHER", _BArRec_OTHER	);
				scenario->set_parameter(document, section, "BArRet_OTHER", _BArRet_OTHER	);
				scenario->set_parameter(document, section, "BArEnt_OTHER", _BArEnt_OTHER	);
				scenario->set_parameter(document, section, "BArIns_OTHER", _BArIns_OTHER	);
				scenario->set_parameter(document, section, "BArOff_OTHER", _BArOff_OTHER	);
				scenario->set_parameter(document, section, "BArMix_OTHER", _BArMix_OTHER	);
				scenario->set_parameter(document, section, "BArSch_OTHER", _BArSch_OTHER	);
				scenario->set_parameter(document, section, "BEmOth_OTHER", _BEmOth_OTHER	);
				scenario->set_parameter(document, section, "BEmInd_OTHER", _BEmInd_OTHER	);
				scenario->set_parameter(document, section, "BEmGov_OTHER", _BEmGov_OTHER	);
				scenario->set_parameter(document, section, "BEmSer_OTHER", _BEmSer_OTHER	);
				scenario->set_parameter(document, section, "BEmMan_OTHER", _BEmMan_OTHER	);
				scenario->set_parameter(document, section, "BEmRet_OTHER", _BEmRet_OTHER	);
				scenario->set_parameter(document, section, "THETAG_OTHER", _THETAG_OTHER	);
				scenario->set_parameter(document, section, "THETAM_OTHER", _THETAM_OTHER	);
				scenario->set_parameter(document, section, "THETAR_OTHER", _THETAR_OTHER	);
				scenario->set_parameter(document, section, "THETAS_OTHER", _THETAS_OTHER	);
				scenario->set_parameter(document, section, "THETAI_OTHER", _THETAI_OTHER	);
				scenario->set_parameter(document, section, "THETAO_OTHER", _THETAO_OTHER	);
				scenario->set_parameter(document, section, "GAMMA_OTHER" , _GAMMA_OTHER 	);

				scenario->set_parameter(document, section, "BTTAUTO_WORK", _BTTAUTO_WORK	);
				scenario->set_parameter(document, section, "BINCD_WORK"	 , _BINCD_WORK		);
				scenario->set_parameter(document, section, "BRACED_WORK" , _BRACED_WORK 	);
				scenario->set_parameter(document, section, "BArRes_WORK" , _BArRes_WORK 	);
				scenario->set_parameter(document, section, "BArRec_WORK" , _BArRec_WORK 	);
				scenario->set_parameter(document, section, "BArRet_WORK" , _BArRet_WORK 	);
				scenario->set_parameter(document, section, "BArEnt_WORK" , _BArEnt_WORK 	);
				scenario->set_parameter(document, section, "BArIns_WORK" , _BArIns_WORK 	);
				scenario->set_parameter(document, section, "BArOff_WORK" , _BArOff_WORK 	);
				scenario->set_parameter(document, section, "BArMix_WORK" , _BArMix_WORK 	);
				scenario->set_parameter(document, section, "BArSch_WORK" , _BArSch_WORK 	);
				scenario->set_parameter(document, section, "BEmOth_WORK" , _BEmOth_WORK 	);
				scenario->set_parameter(document, section, "BEmInd_WORK" , _BEmInd_WORK 	);
				scenario->set_parameter(document, section, "BEmGov_WORK" , _BEmGov_WORK 	);
				scenario->set_parameter(document, section, "BEmSer_WORK" , _BEmSer_WORK 	);
				scenario->set_parameter(document, section, "BEmMan_WORK" , _BEmMan_WORK 	);
				scenario->set_parameter(document, section, "BEmRet_WORK" , _BEmRet_WORK 	);
				scenario->set_parameter(document, section, "THETAG_WORK" , _THETAG_WORK 	);
				scenario->set_parameter(document, section, "THETAM_WORK" , _THETAM_WORK 	);
				scenario->set_parameter(document, section, "THETAR_WORK" , _THETAR_WORK 	);
				scenario->set_parameter(document, section, "THETAS_WORK" , _THETAS_WORK 	);
				scenario->set_parameter(document, section, "THETAI_WORK" , _THETAI_WORK 	);
				scenario->set_parameter(document, section, "THETAO_WORK" , _THETAO_WORK 	);

				scenario->set_parameter(document, section, "BTTTRAN_WORK", _BTTTRAN_WORK     		);
				scenario->set_parameter(document, section, "BTTOTHER_WORK", _BTTOTHER_WORK    		);
				scenario->set_parameter(document, section, "BHOME_WORK", _BHOME_WORK       			);
				scenario->set_parameter(document, section, "BEmUnrelated_WORK", _BEmUnrelated_WORK	);
				scenario->set_parameter(document, section, "THETA_UR_WORK", _THETA_UR_WORK    		);
