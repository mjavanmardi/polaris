...
int main(int argc,char** argv)
{
	...
	if (debug_route)
	{
		...
		summary_title << "Thread\tOrigin\tDestination\tDeparture_Time\tSub_Mode\tArrival_Time\tGen_Cost\tDuration\tWait_Count\tWait_Time\tWalk_Time\tBike_Time\tIVTT\tCar_Time\tTransfer_Pen\tEst_Cost\tScan_Count\taStar_Time\tSuccess_Status\tNeighbor_Visit_Time\n";
