...
void PopulateComponent(std::string db_path)
{
	...
	std::cout << "Deleteting: Action_Key, Action_Keys, Action, Component\n";
	...
	try
	{
		...
		std::cout << "Adding Depot component\n";
		//Component
		...
		std::cout << "Adding Open Shoulder component\n";
		//Component
		...
		std::cout << "Adding TrafficSignal, TollStation, FixedSensor, ProbeVehicle, VehicleIdetificationSensor components\n";
		///Other Components
