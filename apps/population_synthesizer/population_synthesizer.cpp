...
struct MasterType
{
	...
	typedef Person_Components::Implementations::ADAPTS_Destination_Chooser_Implementation<M,person_type> person_destination_chooser_type;
	typedef Person_Components::Implementations::ADAPTS_Destination_Choice_Option<M,person_type> person_destination_choice_option_type;
	typedef Person_Components::Implementations::Mode_Chooser_Implementation<M,person_type> person_mode_chooser_type;
	typedef Person_Components::Implementations::Polaris_Mode_Choice_Option<M,person_type> mode_choice_option_type;
...
int main(int argc,char** argv)
{
	...
	los_value_itf* los_val = (los_value_itf*)Allocate<MasterType::los_value_type>();
	los_invariant_value_itf* los_invar = (los_invariant_value_itf*)Allocate<Network_Skimming_Components::Implementations::LOS_Time_Invariant_Value_Implementation<NT>>();
	los_val->LOS_time_invariant<los_invariant_value_itf*>(los_invar);

	//cout << los_val->transit_ttime<Time_Seconds>() << ", " << los_val->transit_fare<Basic_Units::Currency_Variables::Cents>()<<endl;
