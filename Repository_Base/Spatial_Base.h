...
namespace Spatial_API
{
	...
	typedef Polaris_Component<Interfaces::Coordinate_System_Interface,XY_Coordinate_System_Base> XY_Coordinate_System;
	...
	typedef Polaris_Component<Interfaces::Coordinate_System_Interface,UTM_Coordinate_System_Base> UTM_Coordinate_System;
}
