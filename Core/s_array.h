...
public:
    ...
    s_array_iterator(T* data, vector<size_type>* row_sizes, pair<size_type,size_type>* cursor)
    {	// copy constructor
		_fixed_dim = -1;
		_fixed_dim_val = -1;
	...
	s_array_iterator(T* data, vector<size_type>* row_sizes, pair<size_type,size_type>* cursor, size_type fixed_dim, size_type fixed_dim_val)
	{		
		// copy constructor
...
private:
	...
	vector<size_type>* _row_sizes;								// dimensional sizes 
