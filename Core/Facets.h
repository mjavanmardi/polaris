...
#define facet_accessor_interface(FACET_NAME)\
	...
	template<typename TargetType>\
	TargetType::Interface_Type<TargetType,CallerType>::type* FACET_NAME(call_requirements((requires(ThisType,Is_Dispatchable) && requires(ThisType,FACET_NAME##_get_check))))\
	{\
		return PTHIS(ThisType)->FACET_NAME<Dispatch<ThisType>,CallerType,TargetType>();\
	}\
	template<typename TargetType>\
	...
	template<typename TargetType>\
	void FACET_NAME(TargetType::Interface_Type<TargetType,CallerType>::type* set_value,call_requirements((requires(ThisType,Is_Dispatchable) && requires(ThisType,FACET_NAME##_set_check))))\
	{\
		PTHIS(ThisType)->FACET_NAME<Dispatch<ThisType>,CallerType,TargetType>(set_value);\
	}\
	template<typename TargetType>\
...
#define member_component_basic(COMPONENT_TYPE,FACET_NAME)\
	protected:\
	COMPONENT_TYPE::Interface_Type<NULLTYPE,NULLTYPE>::type* _##FACET_NAME;\
	public:\
