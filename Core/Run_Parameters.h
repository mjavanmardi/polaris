...
static const unsigned int _num_iterations=1440; // 2 days
static const int _num_threads=4;

static const int _Max_Message_Size=5*1048576;

static const long long _Page_Size=4096/8;
static const long long _Max_Pages=(_Megabytes_To_Allocate*1048576)/_Page_Size;

typedef Basic_Units::Time_Variables::Time_Minutes Simulation_Timestep_Increment;
