...
#define define_container_and_value_interface_external(PROTOTYPE, COMPONENT_TYPE, FEATURE_LINKED_TO_TYPE,CONTAINER_ALIAS,VALUE_PROTOTYPE,VALUE_ALIAS,CALLER_TYPE)\
	typedef VALUE_PROTOTYPE<typename COMPONENT_TYPE::FEATURE_LINKED_TO_TYPE##_type::unqualified_value_type,CALLER_TYPE> VALUE_ALIAS;\
	typedef PROTOTYPE<typename COMPONENT_TYPE::FEATURE_LINKED_TO_TYPE##_type,CALLER_TYPE,VALUE_ALIAS*> CONTAINER_ALIAS
