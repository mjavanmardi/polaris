...
#define define_component_interface_local(COMPONENT_ALIAS,PROTOTYPE_TEMPLATE,LOCAL_FEATURE_LINKED_TO_TYPE,CALLER_TYPE)\
	typedef typename ComponentType::LOCAL_FEATURE_LINKED_TO_TYPE##_type COMPONENT_ALIAS##_type;\
	typedef PROTOTYPE_TEMPLATE<COMPONENT_ALIAS##_type,CALLER_TYPE> COMPONENT_ALIAS

#define define_component_interface(COMPONENT_ALIAS,PROTOTYPE_TEMPLATE,NON_LOCAL_FEATURE_LINKED_TO_TYPE,CALLER_TYPE)\
	typedef NON_LOCAL_FEATURE_LINKED_TO_TYPE##_type COMPONENT_ALIAS##_type;\
	typedef PROTOTYPE_TEMPLATE<COMPONENT_ALIAS##_type,CALLER_TYPE> COMPONENT_ALIAS

#define define_value_interface_local(VALUE_PROTOTYPE,LOCAL_FEATURE_LINKED_TO_CONTAINER_TYPE,VALUE_ALIAS,CALLER_TYPE)\
	typedef typename ComponentType::LOCAL_FEATURE_LINKED_TO_CONTAINER_TYPE##_type::unqualified_value_type VALUE_ALIAS##_type;\
	typedef VALUE_PROTOTYPE<VALUE_ALIAS##_type,CALLER_TYPE> VALUE_ALIAS;

#define define_container_interface_local(CONTAINER_PROTOTYPE,LOCAL_FEATURE_LINKED_TO_CONTAINER_TYPE,CONTAINER_ALIAS,TARGET_VALUE_INTERFACE,CALLER_TYPE)\
	typedef typename ComponentType::LOCAL_FEATURE_LINKED_TO_CONTAINER_TYPE##_type CONTAINER_ALIAS##_type;\
	typedef CONTAINER_PROTOTYPE<CONTAINER_ALIAS##_type,CALLER_TYPE,TARGET_VALUE_INTERFACE*> CONTAINER_ALIAS

#define define_container_and_value_interface_local(CONTAINER_PROTOTYPE,LOCAL_FEATURE_LINKED_TO_CONTAINER_TYPE,CONTAINER_ALIAS,VALUE_PROTOTYPE,VALUE_ALIAS,CALLER_TYPE)\
	typedef typename ComponentType::LOCAL_FEATURE_LINKED_TO_CONTAINER_TYPE##_type::unqualified_value_type VALUE_ALIAS##_type;\
	typedef VALUE_PROTOTYPE<VALUE_ALIAS##_type,CALLER_TYPE> VALUE_ALIAS;\
	typedef typename ComponentType::LOCAL_FEATURE_LINKED_TO_CONTAINER_TYPE##_type CONTAINER_ALIAS##_type;\
	typedef CONTAINER_PROTOTYPE<CONTAINER_ALIAS##_type,CALLER_TYPE,VALUE_ALIAS*> CONTAINER_ALIAS

#define define_value_interface(VALUE_PROTOTYPE,NON_LOCAL_FEATURE_LINKED_TO_CONTAINER_TYPE,VALUE_ALIAS,CALLER_TYPE)\
	typedef NON_LOCAL_FEATURE_LINKED_TO_CONTAINER_TYPE##_type::unqualified_value_type VALUE_ALIAS##_type;\
	typedef VALUE_PROTOTYPE<VALUE_ALIAS##_type,CALLER_TYPE> VALUE_ALIAS;

#define define_container_interface(CONTAINER_PROTOTYPE,NON_LOCAL_FEATURE_LINKED_TO_CONTAINER_TYPE,CONTAINER_ALIAS,TARGET_VALUE_INTERFACE,CALLER_TYPE)\
	typedef NON_LOCAL_FEATURE_LINKED_TO_CONTAINER_TYPE##_type CONTAINER_ALIAS##_type;\
	typedef CONTAINER_PROTOTYPE<CONTAINER_ALIAS##_type,CALLER_TYPE,TARGET_VALUE_INTERFACE*> CONTAINER_ALIAS

#define define_container_and_value_interface(CONTAINER_PROTOTYPE,NON_LOCAL_FEATURE_LINKED_TO_CONTAINER_TYPE,CONTAINER_ALIAS,VALUE_PROTOTYPE,VALUE_ALIAS,CALLER_TYPE)\
	typedef NON_LOCAL_FEATURE_LINKED_TO_CONTAINER_TYPE##_type::unqualified_value_type VALUE_ALIAS##_type;\
	typedef VALUE_PROTOTYPE<VALUE_ALIAS##_type,CALLER_TYPE> VALUE_ALIAS;\
	typedef NON_LOCAL_FEATURE_LINKED_TO_CONTAINER_TYPE##_type CONTAINER_ALIAS##_type;\
	typedef CONTAINER_PROTOTYPE<CONTAINER_ALIAS##_type,CALLER_TYPE,VALUE_ALIAS*> CONTAINER_ALIAS
#define define_simple_container_interface_local(CONTAINER_PROTOTYPE, LOCAL_FEATURE_LINKED_TO_CONTAINER_TYPE, CONTAINER_ALIAS, VALUE_TYPE, CALLER_TYPE)\
	typedef typename ComponentType::LOCAL_FEATURE_LINKED_TO_CONTAINER_TYPE##_type CONTAINER_ALIAS##_type;\
...
#define define_value_interface(INTERFACE_TEMPLATE,FACET_LINKED_TO_TYPE,CONTAINER_ALIAS,TARGET_VALUE_INTERFACE,CALLER_TYPE)\
