...
public:
	...
	Component_Property_Keys (int id_, shared_ptr<Component> component_id_, std::string key_, std::string value_type_, std::string value_constraint_, bool is_state_, bool required_, std::string note_)
	: id (id_), component_id (component_id_), key (key_), value_type (value_type_), value_constraint (value_constraint_), is_state (is_state_), required (required_), note (note_)
	{
	}
	//Accessors
	const int& getId () const {return id;}
...
public:
    // Default Constructor
    Action_Keys () {}        
	Action_Keys (int id_, shared_ptr<Action> action_id_, std::string key_, std::string value_type_, std::string value_constraint_, bool required_, std::string note_)
	: id (id_), action_id (action_id_), key (key_), value_type (value_type_), value_constraint (value_constraint_), required (required_), note (note_)
	{
	}
	//Accessors
	const int& getId () const {return id;}
